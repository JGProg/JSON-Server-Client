...
using System.Linq;
using CommunicationProtocolNamespace;
...
namespace System.Web
{
    ...
    public static class JSON
    {
        ...
        public static string Serialize(object obj, JSONSerializationMode mode)
        {
            ...
            if (type.IsNumeric() || type == typeof(UInt32) || type == typeof(UInt16))
            {
                return obj.ToString();
            }
        ...
        private static bool IgnoreProperty(PropertyInfo prop)
        {
            ...
            Type[] ignoredTypes = new Type[] { typeof(Type), typeof(TextWriter), typeof(Stream) };
